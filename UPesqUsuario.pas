...
begin
  try
    FDQUsuario.Delete;
    Application.MessageBox('Usuário exlcuído com sucesso!', 'Pâmela Artes', MB_ICONINFORMATION);
...
begin
  ...
  begin
    ...
    if Application.MessageBox(PChar('Deseja realmente excluir o usuário ' + sUsuario + ' ?'), 'Pâmela Artes', MB_ICONQUESTION + MB_YESNO + MB_DEFBUTTON2) = ID_YES then
      excluirUsuario;
  end;
end;
