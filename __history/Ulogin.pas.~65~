...
begin
  ...
  try
    ...
    begin
      ...
      begin
        Application.MessageBox('Usuário ou senha inválido!', 'Pâmela Artes', MB_ICONWARNING);
      end
      else
      begin
...
begin
  ...
  begin
    Application.MessageBox('Informe o usuário!', 'Pâmela Artes', MB_ICONQUESTION);
    edtUsuario.SetFocus;
    Abort;
  end;
  ...
  begin
    Application.MessageBox('Informe o senha!', 'Pâmela Artes', MB_ICONINFORMATION);
    edtSenha.SetFocus;
    Abort;
  end;
