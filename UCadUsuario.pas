...
begin
  ...
  begin
    Application.MessageBox('Favor informar o nome!', 'Pâmela Artes', MB_ICONINFORMATION);
    edtNome.SetFocus;
  end;

  if Trim(edtUsuario.Text) = '' then
  begin
    Application.MessageBox('Favor informar o usuário!', 'Pâmela Artes', MB_ICONINFORMATION);
    edtUsuario.SetFocus;
  end;

  if Trim(edtSenha.Text) = '' then
  begin
    Application.MessageBox('Favor informar a senha!', 'Pâmela Artes', MB_ICONINFORMATION);
    edtSenha.SetFocus;
  end;
...
begin
  ...
  try
    ...
    Application.MessageBox('Usuário salvo com sucesso!', 'Pâmela Artes', MB_ICONINFORMATION);
